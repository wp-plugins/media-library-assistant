...
//error_log( 'DEBUG: MLA_Ajax::mla_admin_init_action() $_REQUEST = ' . var_export( $_REQUEST, true ), 0 );
	...
	public static function mla_set_parent_ajax_action() {
		...
		if ( ! class_exists( 'MLAData' ) ) {
			...
			MLAData::initialize();
//error_log( __LINE__ . ' MEMORY class-mla-ajax.php class-mla-data.php ' . number_format( memory_get_peak_usage( true ) ), 0);
		}
...
//error_log( __LINE__ . ' MEMORY class-mla-ajax.php class-mla-list-table.php ' . number_format( memory_get_peak_usage( true ) ), 0);
		}
