...
//error_log( __LINE__ . ' MEMORY class-mla-core.php ' . number_format( memory_get_peak_usage( true ) ), 0);
...
//error_log( __LINE__ . ' MEMORY class-mla-core.php class-mla-objects.php ' . number_format( memory_get_peak_usage( true ) ), 0);
